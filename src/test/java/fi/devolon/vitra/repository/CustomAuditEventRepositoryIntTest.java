...
import fi.devolon.vitra.config.audit.AuditEventConverter;
import fi.devolon.vitra.domain.PersistentAuditEvent;
...
import static fi.devolon.vitra.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
